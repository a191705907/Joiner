            ...
            <s:if test="#session.activityList!=null">
                <s:iterator value="#session.activityList" id="activity1">
                    <form action="activityInformation" method="post" name="activityInformation" validate="true">
                        <input type="hidden" name="activity1.activityId" value="<s:property value="#activity1.activityId"/>">
        ...
        <div class="right">
            ...
            <div class="event-name">
                <form  name="create_activity" method="post" action="create_activity" validate="true">
                    <input type="hidden" name="activity.organizerName" value="<s:property value="#seesion.organizer.organizerName"/>">
                    <input type="hidden" name="activity.isPost" value="1">
                    <p>Event Name:</p>
                    ...
                    <p>Event detial:</p>
                    <textarea type="text" style="width: 800px; height: 100px;" name="activity.place"> </textarea>
                    <p>
